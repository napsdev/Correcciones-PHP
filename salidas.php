                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- Contenido wey -->
                                    <form role="form" method="post" class="formulariosalidas" target="_blank" onsubmit="setTimeout(function () { window.location.reload(); }, 100)" name="factura" id="factura1" action="php/salidas/agregarsalida.php">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <h4>Enviar correo?</h4>
                                                        <div class="form-group">
                                                        <select class="selectpicker show-menu-arrow" name="enviar" data-style="form-control" title="Enviar correo?" required>
                                                            <option data-tokens="No">No</option>
                                                            <option data-tokens="Si" selected>Sí</option>
                                                        </select>
                                                        </div>
                                                    ...
                                                    <button type="submit" id="miboton" class="btn btn-primary">Agregar</button>
